      ...
      var o,
        ...
        i = (e.elemPicker = k(
          [
            ...
            '<button class="layui-btn layui-layui-btn layui-btn-sm" colorpicker-events="clear">\u6e05\u7a7a</button>',
...
layui.define(['laytpl', 'form'], function (e) {
  ...
  var s = layui.$,
    ...
    p = [
      ...
      '<button type="button" class="layui-btn layui-btn-sm layui-layui-btn layui-btn-disabled" data-index="0">',
      '<i class="layui-icon layui-icon-next"></i>',
      '</button>',
      '<button type="button" class="layui-btn layui-btn-sm layui-layui-btn layui-btn-disabled" data-index="1">',
      ...
      var l = this,
        t = c.open({
          ...
          content: [
            ...
            '<button style="margin-left: 20px;" type="button" class="layui-btn layui-layui-btn"> \u53d6\u6d88 </button>',
            '</li>',
            '</ul>',
          ].join(''),
          success: function (t, e) {
            a.render('radio'),
              t.find('.layui-layui-btn').on('click', function () {
                c.close(e), l.focus()
              }),
